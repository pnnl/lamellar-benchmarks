...
fn main() {
    ...
    if my_pe == 0 {
        println!("{{\"updates_per_pe\":{},\"num_pes\":{},\"total_updates\":{},\"table_size_per_pe\":{},\"buffer_amt\":{},\"num_threads\":{},\"execution_time_secs\":{:.6},\"mups\":{:.6},\"gb_per_sec_injection_rate\":{:.6},\"mb_sent\":{:.6},\"mb_per_sec\":{:.6}}}",
            l_num_updates,
            num_pes,
